		...
		>
			...
			<nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-6 mix-blend-difference">
				...
				<button
					...
					className="relative flex flex-col gap-1.5 z-60 md:hidden p-2 group"
				...
				<div className="grid items-center gap-16 vdf-reveal lg:grid-cols-2">
					<div>
						...
						<div className="space-y-6 text-lg leading-relaxed text-neutral-400">
							...
							<p>
								Outside of development, I spend my time exploring anime, TV and
								movies, and gaming—I absolutely love my Steam Deck. I also stay
								active through biking, hiking, and the gym. Curiosity and
								continuous learning drive everything I do.
							</p>
						</div>
					</div>
